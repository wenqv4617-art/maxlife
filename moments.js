  ...
  async function ensureStoreObject() {
    ...
    if (!rec) {
      rec = {
        ...
        posts: [], // {id, authorType,userMaskId,charId,charGroup,text,images[],visibleGroups[],visibleChars[],likes[],comments[],forwards[],createdAt}
        autoRules: {}, // convId -> { enabled, timeHM, lastSentDay }
      };
