...
async function injectSingleOfflineControl() {
    ...
    try {
        ...
        let section = cleanupDuplicateOfflinePanels(page, "single");
        ...
        if (!section) {
            ...
            section = cleanupDuplicateOfflinePanels(page, "single");
        } else {
            syncPanelValues("single", control);
        }
    ...
    try {
        ...
        let section = cleanupDuplicateOfflinePanels(page, "group");
        ...
        if (!section) {
            ...
            section = cleanupDuplicateOfflinePanels(page, "group");
        } else {
            syncPanelValues("group", control);
        }
