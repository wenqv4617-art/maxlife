...
function bindGroupBubbleToolbar(container, msgs) {
    ...
    container.querySelectorAll('.bubble-dot').forEach(dot => {
        dot.addEventListener('click', (e) => {
            e.stopPropagation();
            var parent = dot.closest('.group-message-row') || dot.closest('[data-offline-msg-id]');
            var toolbar = parent.querySelector('.bubble-toolbar');
            container.querySelectorAll('.bubble-toolbar.show').forEach(function(tb) {
