...
(function() {
    ...
    function sanitize(html) {
        ...
        tmp.innerHTML = html;
        var bad = tmp.querySelectorAll("script,iframe,object,embed,form,link,meta,base,style");
    ...
    function resolve(opts) {
        ...
        for (var m = 0; m < mounted.length; m++) {
            ...
            if (w.group === "HTML") {
                result.hasHtml = true;
                text += "\n\n[HTML Card Rule] When user triggers this topic, output: [MSG]html_card:<your html>. Use inline styles or card utility classes (card-header, card-body, card-footer, card-tag, card-divider, card-highlight, card-grid, card-grid-item, card-progress, card-progress-bar). No script tags. Output raw HTML directly.";
            }
