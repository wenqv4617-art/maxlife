...
4. 【写作要求】
   ...
   - 情感要真实复杂，可以有矛盾、犹豫、不确定——真实的日记本来就不是非黑即白的
   - 可以写一两件日常小事，从小事中折射出你的性格和情感
   - 语气要像真的在和自己对话，可以喃喃自语、可以反问自己、可以有未完成的思考
   - 禁止写"今天天气很好"这种模板化开头。直接从心里想的事情开始写
   - 不要写成作文，要像真实日记——可能有点乱、有点碎、不太完美，但真实

【格式要求】
- 日期是今天（${new Date().toLocaleDateString('zh-CN')}），绝对禁止用其他日期
- 内容400-600字，可以分段
- 标题要有文学感，能隐约透露日记的情绪基调
- 只生成一篇
