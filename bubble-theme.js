...
const DEFAULT_ICON_MAP = {
  ...
  return [
    ...
    '  <div class="message-row other"><div class="message-avatar" style="background:#7aa;">C</div><div class="bubble image-bubble media-bubble"><div class="media-bubble-row"><span class="media-bubble-icon">' + imageSvg + '</span><div class="media-bubble-main"><div class="media-bubble-title">图片</div><div class="media-bubble-desc">对方发送的图片描述</div></div></div></div></div>',

    '  <div class="message-row self"><div class="bubble voice-bubble media-bubble"><div class="media-bubble-row"><span class="media-bubble-icon">' + micSvg + '</span><div class="media-bubble-main"><div class="media-bubble-title">语音消息</div><div class="media-bubble-desc">点击展开内容</div></div><span class="voice-duration">7\\\'\\\'</span></div></div><div class="message-avatar" style="background:#c88;">U</div></div>',
