...
'  <div class="message-row self"><div class="bubble voice-bubble"><span class="voice-icon">' + micSvg + '</span><span class="voice-duration">7"</span></div><div class="message-avatar" style="background:#c88;">U</div></div>',
