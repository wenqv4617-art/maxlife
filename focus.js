...
(function() {
    ...
    function bindFocusEvents() {
        ...
        if (expandMenu && !document.querySelector('.expand-menu-item[data-action="focus"]')) {
            ...
            focusItem.innerHTML = '<span class="expand-menu-icon">🧘</span><span class="expand-menu-label">专注</span>';
    ...
    function renderFocusPreview(dataUrl) {
        ...
        if (!preview) return;
        if (dataUrl) {
            preview.innerHTML = `<img src="${dataUrl}" style="max-width:100%; border-radius:12px;" alt="立绘预览">`;
        } else {
